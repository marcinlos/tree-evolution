...
from tree_evolution.evolution import Evolution, ForestRepresentation, random_expr_tree
...
# %%
expr1 = random_expr_tree(depth=1, unary=unary_operators(), binary=binary_operators())
expr2 = random_expr_tree(depth=1, unary=unary_operators(), binary=binary_operators())
